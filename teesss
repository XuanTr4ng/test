...
shared.LoaderTitle = 'Speed Hub' -- ใส่ชื่อ
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		["title"] = "Speed Hub Webhooks Status**",
		["color"] = 1127128,
		["fields"] = {
			{
				["name"] = "User Name",
...
Main:AddToggle({
    Name = "AutoFarm",
	Value = _G.Settings.AutoFarm, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
        _G.AutoFarm = value
        _G.AutoFarmLv = value
